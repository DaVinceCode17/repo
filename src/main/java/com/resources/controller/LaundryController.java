    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if ("/customers".equals(path)) {
                ...
                Order o = service.getOrdersByCustomer(id).stream().findFirst().orElse(null);
                if (o != null) {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if (path != null && path.startsWith("/order/status/")) {
                ...
                Order o = service.moveToOngoing(orderId);
                out.write("{\"success\":true,\"order\":{\"id\":" + o.getId() + ",\"status\":\"" + o.getStatus() + "\",\"weight\":" + weight + ",\"price\":" + price + "}}");
            } else {
                out.write("{\"success\":false,\"message\":\"Invalid endpoint\"}");
            }
        } catch (Exception e) {
